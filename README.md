...
| Path | What it is |
|---|---|
| `site/laundrykings-site.html` | The complete website (marketing, customer app, ops backend) as one file. v4.7, byte-identical to the live artefact. |
| `verify/preflight.py` | Pre-publish checks. Run before every publish. |
| `site/photos/` | Journey photographs, the sourcing brief, the alt text and `CREDITS.md` — the licence record. Empty until the photos land; the journey section ships text-only until they do. |
...
| `dossier/LKG-GOV00-02_Build Session Brief_v1.pdf` | v4.3–v4.7 build log, AU compliance actions, open decisions and the drafted solicitor brief. 19 September 2026. |
